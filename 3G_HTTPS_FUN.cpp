...
bool PreSetting()
{
	...
	ManageAtCommand(pCom1,NULL,ListRsp,3000);
	ListRsp[1] = "*\r\nOK\r\n";
    // ---------------------------------------
	...
	while (i<=4)
	{
		...
		{
			DisplayAndLogTest(pLogFile, "The GPRS Bearer set up failed!!\n");
			i++;
		}
		else
		{
...
//	strcat(strInputFile,TestName);
	strcat(strInputFile,"3G_HTTPS_FUN_WTF");
...
//----------------------O_3G_WIP_HTTPS_FUN_GCC_0001 (end)--------------------//

//----------------------O_3G_WIP_HTTPS_FUN_GCC_0002 -------------------------//

	// execute test 0002
	TestParam_init(&test_params);
	test_params.need_passed=0;
	test_params.str_test  = "O_3G_WIP_HTTPS_FUN_GCC_0002";
...
//----------------------O_3G_WIP_HTTPS_FUN_GCC_0002 (end)--------------------//

//----------------------O_3G_WIP_HTTPS_FUN_GCC_0003 -------------------------//

	// execute test 0003
	TestParam_init(&test_params);
	test_params.need_passed=0;
	test_params.str_test  = "O_3G_WIP_HTTPS_FUN_GCC_0003";
...
//----------------------O_3G_WIP_HTTPS_FUN_GCC_0003 (end)--------------------//

//----------------------O_3G_WIP_HTTPS_FUN_GCC_0004 -------------------------//

	// execute test 0004
	TestParam_init(&test_params);
	test_params.need_passed=0;
	test_params.timeout=25000;
	test_params.str_test  = "O_3G_WIP_HTTPS_FUN_GCC_0004";
...
//----------------------O_3G_WIP_HTTPS_FUN_GCC_0004 (end)--------------------//

//----------------------O_3G_WIP_HTTPS_FUN_GCC_0005 -------------------------//

	// execute test 0005
	TestParam_init(&test_params);
	test_params.need_passed=0;
	test_params.str_test  = "O_3G_WIP_HTTPS_FUN_GCC_0005";
...
//----------------------O_3G_WIP_HTTPS_FUN_GCC_0005 (end)--------------------//
...
//----------------------O_3G_WIP_HTTPS_FUN_GCC_0006 -------------------------//

	// execute test 0004
	TestParam_init(&test_params);
	strcpy(TestResult,"WIP_CEV_PEER_CLOSE");
	test_params.timeout=28000;
	test_params.str_test  = "O_3G_WIP_HTTPS_FUN_GCC_0006";
	test_params.str_wtrun = "O_TEST_0004";
	// Enable the WIP DEBUG mode.
	if (ManageAtCommand(pCom1,"AT+WIPDBG=1\r",ListRsp,8000) != 1)
    {
        DisplayAndLogTest(pLogFile, "Cannot disable the Debug mode!\n");
    }
	Wait(5);
...
//----------------------O_3G_WIP_HTTPS_FUN_GCC_0006 (end)--------------------//

//----------------------O_3G_WIP_HTTPS_FUN_GCC_0008 -------------------------//

	// execute test 0006
	TestParam_init(&test_params);
	test_params.need_passed=0;
	test_params.timeout=20000;
	test_params.str_test  = "O_3G_WIP_HTTPS_FUN_GCC_0008";
...
//----------------------O_3G_WIP_HTTPS_FUN_GCC_0008 (end)--------------------//

//----------------------O_3G_WIP_HTTPS_FUN_GCC_0009 -------------------------//

	// execute test 0007
	TestParam_init(&test_params);
	test_params.need_passed=0;
	test_params.timeout=25000;
	test_params.str_test  = "O_3G_WIP_HTTPS_FUN_GCC_0009";
...
//----------------------O_3G_WIP_HTTPS_FUN_GCC_0009 (end)--------------------//

//----------------------O_3G_WIP_HTTPS_FUN_GCC_0010 -------------------------//

	// execute test 0001
	TestParam_init(&test_params);
	strcpy(TestResult,"HTTPS data channel is closed");
	test_params.timeout=20000;
	test_params.str_test  = "O_3G_WIP_HTTPS_FUN_GCC_0010";
	test_params.str_wtrun = "O_TEST_0001";
...
//----------------------O_3G_WIP_HTTPS_FUN_GCC_0010 (end)--------------------//

	Wait (10);
//----------------------O_3G_WIP_HTTPS_FUN_GCC_0011 -------------------------//

	// execute test 0001
	TestParam_init(&test_params);
	strcpy(TestResult,"HTTPS transfer channel is closed");
	test_params.timeout=20000;
	test_params.str_test  = "O_3G_WIP_HTTPS_FUN_GCC_0011";
	test_params.str_wtrun = "O_TEST_0001";
	if(TestRunWTSS(1, &test_params) < 0)
	{
		error = 1;
...
//----------------------O_3G_WIP_HTTPS_FUN_GCC_0011 (end)--------------------//

//----------------------O_3G_WIP_HTTPS_FUN_GCC_0012 -------------------------//

	// execute test 0010
	TestParam_init(&test_params);
	test_params.need_passed=0;
	test_params.timeout=25000;
	test_params.str_test  = "O_3G_WIP_HTTPS_FUN_GCC_0012";
...
//----------------------O_3G_WIP_HTTPS_FUN_GCC_0012 (end)--------------------//
