...
//	strcat(strInputFile,TestName);
	strcat(strInputFile,"HTTPS_CUS44486");
//	strcat(strInputFile,MemoryType);
  ...
  if(mode!=1)
	...
	if (ManageAtCommand(pCom1,NULL,ListRsp,100000) != 2)
    {
...
//------------------------- Run Test O_WIP_HTTPS_APP_GCC_0011------------------------------------------//
	result=1;
	...
	if (result == 0) pLogFile->WriteComment("\n\nStatus O_WIP_HTTPS_APP_GCC_0011: FAILED\r");
	else pLogFile->WriteComment("\n\nStatus O_WIP_HTTPS_APP_GCC_0011: PASSED\r");
	Wait (5);
//---------------------------------O_WIP_HTTPS_APP_GCC_0011 (end)---------------------------------------//

//------------------------- Run Test O_WIP_HTTPS_APP_GCC_0012------------------------------------------//
	result1=1;
	...
	if (result1 == 0) pLogFile->WriteComment("\n\nStatus O_WIP_HTTPS_APP_GCC_0012: FAILED\r");
	else pLogFile->WriteComment("\n\nStatus O_WIP_HTTPS_APP_GCC_0012: PASSED\r");
//---------------------------------O_WIP_HTTPS_APP_GCC_0012 (end)---------------------------------------//

//------------------------- Run Test O_WIP_HTTPS_APP_GCC_0028------------------------------------------//
	result2=1;
	...
	if (result2 == 0) pLogFile->WriteComment("\n\nStatus O_WIP_HTTPS_APP_GCC_0028: FAILED\r");
	else pLogFile->WriteComment("\n\nStatus O_WIP_HTTPS_APP_GCC_0028: PASSED\r");
//---------------------------------O_WIP_HTTPS_APP_GCC_0028 (end)---------------------------------------//
