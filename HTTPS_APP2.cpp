...
//	strcat(strInputFile,TestName);
	strcat(strInputFile,"HTTPS_APP2_WTF");
...
//----------------------O_WIP_HTTPS_APP_GCC_0014 (end)--------------------//

//----------------------O_WIP_HTTPS_APP_GCC_0016 -------------------------//

	// execute test 0002
	TestParam_init(&test_params);
	test_params.need_passed=0;
	test_params.str_test  = "O_WIP_HTTPS_APP_GCC_0016";
...
//----------------------O_WIP_HTTPS_APP_GCC_0016 (end)--------------------//

//----------------------O_WIP_HTTPS_APP_GCC_0017 -------------------------//

	// execute test 0003
	TestParam_init(&test_params);
	test_params.need_passed=0;
	test_params.str_test  = "O_WIP_HTTPS_APP_GCC_0017";
...
//----------------------O_WIP_HTTPS_APP_GCC_0019 -------------------------//
	...
	test_params.str_test  = "O_WIP_HTTPS_APP_GCC_0019";
...
//----------------------O_WIP_HTTPS_APP_GCC_0019 (end)--------------------//

//----------------------O_WIP_HTTPS_APP_GCC_0020 -------------------------//

	// execute test 0005
	TestParam_init(&test_params);
	test_params.need_passed=0;
	test_params.str_test  = "O_WIP_HTTPS_APP_GCC_0020";
...
//----------------------O_WIP_HTTPS_APP_GCC_0021 -------------------------//

	// execute test 0006
	TestParam_init(&test_params);
	test_params.need_passed=0;
	test_params.timeout=15000;
	test_params.str_test  = "O_WIP_HTTPS_APP_GCC_0021";
...
//----------------------O_WIP_HTTPS_APP_GCC_0021 (end)--------------------//

//----------------------O_WIP_HTTPS_APP_GCC_0025 -------------------------//

	// execute test 0009
	TestParam_init(&test_params);
	test_params.need_passed=0;
	test_params.timeout=20000;
	test_params.str_test  = "O_WIP_HTTPS_APP_GCC_0025";
...
//----------------------O_WIP_HTTPS_APP_GCC_0025 (end)--------------------//

//----------------------O_WIP_HTTPS_APP_GCC_0027 -------------------------//

	// execute test 0010
	TestParam_init(&test_params);
	test_params.need_passed=0;
	test_params.timeout=25000;
	test_params.str_test  = "O_WIP_HTTPS_APP_GCC_0027";
