...
#include "C:\ValidationLibrary\ValidationLibrary\CommonAt.h"
...
//	strcat(strInputFile,TestName);
	strcat(strInputFile,"SIERRA_OAT_FW_752_39_FULL_sl808x");
...
//	strcat(strInputFile,TestName);
	strcat(strInputFile,"SIERRA_BOOT_S4.1.0.7K_sl808x");
//	strcat(strInputFile,MemoryType);
	strcat(strInputFile,FileExtension);
